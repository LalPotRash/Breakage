...
namespace Breakage.Pages
{
    ...
    public partial class ClientsListPage : Page
    {
        ...
        public ClientsListPage()
        {
            ...
            Genders.Insert(0, new Gender { Client = Clients, Name = "Все" });
        ...
        {
            var pageCount = ClientsForFilters.Count % _count == 0 ? ClientsForFilters.Count / _count : ClientsForFilters.Count / _count;
